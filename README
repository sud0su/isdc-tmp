...
paver start_django (only start django)
paver start_geoserver (runs local geoserver using jetty)
paver stop (stop django and geoserver)
paver stop_django (stop django)
paver stop_geoserver (stop geoserver)