    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_file', models.FileField(max_length=500, upload_to=b'documents', null=True, verbose_name='File', blank=True)),
                ('extension', models.CharField(max_length=128, null=True, blank=True)),
                ('version', models.CharField(max_length=50, null=True, blank=True)),
                ('papersize', models.CharField(max_length=2, null=True, blank=True)),
                ('datasource', models.CharField(max_length=128, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(related_name='links', to='documents.Document')),
            ],
        ),
    ]
